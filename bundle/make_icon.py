"""Generate bundle/icon.png for the KitchenSink4PPT .mcpb bundle.

Pure stdlib (zlib + struct): 512x512 RGB PNG (Claude Desktop's recommended
icon size), PowerPoint-orange square with a white water-drop mark (the family faucet mark; the sibling Word bundle uses the same silhouette in faucet blue). Rendered with
...
BG = (196, 62, 28)      # PowerPoint orange
